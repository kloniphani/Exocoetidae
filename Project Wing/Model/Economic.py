...
Columns = ['Counter'] + Scenarios + ScenariosB 
...
Writer = ExcelWriter('./Model/Computed Data/Model.xlsx', engine='xlsxwriter') #Create a Pandas Excel writer using XlsxWriter as the engine.
